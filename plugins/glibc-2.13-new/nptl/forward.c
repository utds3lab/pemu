...
compat_symbol (libc, __pthread_attr_init_2_0, pthread_attr_init, PEMU_LIBC_2_0);
#endif

FORWARD (__pthread_attr_init_2_1, (pthread_attr_t *attr), (attr), 0)
versioned_symbol (libc, __pthread_attr_init_2_1, pthread_attr_init, PEMU_LIBC_2_1);
...
#if SHLIB_COMPAT(libc, PEMU_LIBC_2_0, PEMU_LIBC_2_3_2)
...
compat_symbol (libc, __pthread_cond_init_2_0, pthread_cond_init, PEMU_LIBC_2_0);
#endif
FORWARD (__pthread_cond_init,
	 (pthread_cond_t *cond, const pthread_condattr_t *cond_attr),
	 (cond, cond_attr), 0)
versioned_symbol (libc, __pthread_cond_init, pthread_cond_init, PEMU_LIBC_2_3_2);
