...
#undef timer_settime
versioned_symbol (librt, __timer_settime_new, timer_settime, PEMU_LIBC_2_3_3);


#if SHLIB_COMPAT (librt, PEMU_LIBC_2_2, PEMU_LIBC_2_3_3)
int
...
compat_symbol (librt, __timer_settime_old, timer_settime, PEMU_LIBC_2_2);
#endif
