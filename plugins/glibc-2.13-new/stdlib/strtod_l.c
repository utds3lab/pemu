...
#  ifdef USE_WIDE_CHAR
compat_symbol (libc, __wcstod_l, __wcstold_l, PEMU_LIBC_2_1);
#  else
compat_symbol (libc, __strtod_l, __strtold_l, PEMU_LIBC_2_1);
#  endif
# endif
# if LONG_DOUBLE_COMPAT(libc, PEMU_LIBC_2_3)
#  ifdef USE_WIDE_CHAR
compat_symbol (libc, wcstod_l, wcstold_l, PEMU_LIBC_2_3);
#  else
compat_symbol (libc, strtod_l, strtold_l, PEMU_LIBC_2_3);
#  endif
# endif
#endif
