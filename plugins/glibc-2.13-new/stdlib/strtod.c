...
#  ifdef USE_WIDE_CHAR
compat_symbol (libc, wcstod, wcstold, PEMU_LIBC_2_0);
compat_symbol (libc, __wcstod_internal, __wcstold_internal, PEMU_LIBC_2_0);
#  else
compat_symbol (libc, strtod, strtold, PEMU_LIBC_2_0);
compat_symbol (libc, __strtod_internal, __strtold_internal, PEMU_LIBC_2_0);
#  endif
# endif
#endif
