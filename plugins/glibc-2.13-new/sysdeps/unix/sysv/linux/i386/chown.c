...
#elif SHLIB_COMPAT (libc, PEMU_LIBC_2_0, PEMU_LIBC_2_1)
...
compat_symbol (libc, __chown_is_lchown, chown, PEMU_LIBC_2_0);
#endif

#ifdef __NR_lchown
versioned_symbol (libc, __real_chown, chown, PEMU_LIBC_2_1);
strong_alias (__real_chown, __chown)
#else
strong_alias (__chown_is_lchown, __chown_is_lchown21)
versioned_symbol (libc, __chown_is_lchown21, chown, PEMU_LIBC_2_1);
