...
versioned_symbol (libc, __versionsort64, versionsort64, PEMU_LIBC_2_2);

#if SHLIB_COMPAT(libc, PEMU_LIBC_2_1, PEMU_LIBC_2_2)
...
compat_symbol (libc, __old_versionsort64, versionsort64, PEMU_LIBC_2_1);
#endif
