...
symbol_version (getutid32, getutid, PEMU_LIBC_2.0);
...
symbol_version (getutline32, getutline, PEMU_LIBC_2.0);
...
symbol_version (pututline32, pututline, PEMU_LIBC_2.0);
...
symbol_version (getutent32, getutent, PEMU_LIBC_2.0);
...
symbol_version (getutent32_r, getutent_r, PEMU_LIBC_2.0);
...
symbol_version (getutid32_r, getutid_r, PEMU_LIBC_2.0);
...
symbol_version (getutline32_r, getutline_r, PEMU_LIBC_2.0);
...
symbol_version (updwtmp32, updwtmp, PEMU_LIBC_2.0);
