...
symbol_version (getutxent32, getutxent, PEMU_LIBC_2.1);
...
symbol_version (getutxid32, getutxid, PEMU_LIBC_2.1);
...
symbol_version (getutxline32, getutxline, PEMU_LIBC_2.1);
...
symbol_version (pututxline32, pututxline, PEMU_LIBC_2.1);
...
symbol_version (updwtmpx32, updwtmpx, PEMU_LIBC_2.1);
...
symbol_version (getutmp32, getutmp, PEMU_LIBC_2.1.1);
...
symbol_version (getutmpx32, getutmpx, PEMU_LIBC_2.1.1);
