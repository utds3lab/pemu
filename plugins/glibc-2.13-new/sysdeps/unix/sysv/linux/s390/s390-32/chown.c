...
compat_symbol (libc, __chown_is_lchown, __chown, PEMU_LIBC_2_0);
compat_symbol (libc, _chown_is_lchown, chown, PEMU_LIBC_2_0);

strong_alias (__real_chown, _real_chown)
versioned_symbol (libc, __real_chown, __chown, PEMU_LIBC_2_1);
versioned_symbol (libc, _real_chown, chown, PEMU_LIBC_2_1);
