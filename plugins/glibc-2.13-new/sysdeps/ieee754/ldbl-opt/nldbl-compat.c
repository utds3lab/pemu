...
compat_symbol (libc, __nldbl__IO_printf, _IO_printf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl__IO_sprintf, _IO_sprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl__IO_vfprintf, _IO_vfprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl__IO_vsprintf, _IO_vsprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_dprintf, dprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_fprintf, fprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_printf, printf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_sprintf, sprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_vfprintf, vfprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_vprintf, vprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl__IO_fprintf, _IO_fprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl___vsnprintf, __vsnprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_asprintf, asprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_obstack_printf, obstack_printf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_obstack_vprintf, obstack_vprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_snprintf, snprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_vasprintf, vasprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_vdprintf, vdprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_vsnprintf, vsnprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_vsprintf, vsprintf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl__IO_sscanf, _IO_sscanf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl__IO_vfscanf, _IO_vfscanf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl___vfscanf, __vfscanf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl___vsscanf, __vsscanf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_fscanf, fscanf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_scanf, scanf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_sscanf, sscanf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_vfscanf, vfscanf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_vscanf, vscanf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_vsscanf, vsscanf, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl___printf_fp, __printf_fp, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_strfmon, strfmon, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_syslog, syslog, PEMU_LIBC_2_0);
compat_symbol (libc, __nldbl_vsyslog, vsyslog, PEMU_LIBC_2_0);
#endif
#if LONG_DOUBLE_COMPAT(libc, PEMU_LIBC_2_1)
compat_symbol (libc, __nldbl___asprintf, __asprintf, PEMU_LIBC_2_1);
compat_symbol (libc, __nldbl_printf_size, printf_size, PEMU_LIBC_2_1);
compat_symbol (libc, __nldbl___strfmon_l, __strfmon_l, PEMU_LIBC_2_1);
#endif
#if LONG_DOUBLE_COMPAT(libc, PEMU_LIBC_2_2)
compat_symbol (libc, __nldbl_swprintf, swprintf, PEMU_LIBC_2_2);
compat_symbol (libc, __nldbl_vwprintf, vwprintf, PEMU_LIBC_2_2);
compat_symbol (libc, __nldbl_wprintf, wprintf, PEMU_LIBC_2_2);
compat_symbol (libc, __nldbl_fwprintf, fwprintf, PEMU_LIBC_2_2);
compat_symbol (libc, __nldbl_vfwprintf, vfwprintf, PEMU_LIBC_2_2);
compat_symbol (libc, __nldbl_vswprintf, vswprintf, PEMU_LIBC_2_2);
compat_symbol (libc, __nldbl_fwscanf, fwscanf, PEMU_LIBC_2_2);
compat_symbol (libc, __nldbl_swscanf, swscanf, PEMU_LIBC_2_2);
compat_symbol (libc, __nldbl_vfwscanf, vfwscanf, PEMU_LIBC_2_2);
compat_symbol (libc, __nldbl_vswscanf, vswscanf, PEMU_LIBC_2_2);
compat_symbol (libc, __nldbl_vwscanf, vwscanf, PEMU_LIBC_2_2);
compat_symbol (libc, __nldbl_wscanf, wscanf, PEMU_LIBC_2_2);
#endif
#if LONG_DOUBLE_COMPAT(libc, PEMU_LIBC_2_3)
compat_symbol (libc, __nldbl_strfmon_l, strfmon_l, PEMU_LIBC_2_3);
#endif
#if LONG_DOUBLE_COMPAT(libc, PEMU_LIBC_2_3_4)
compat_symbol (libc, __nldbl___sprintf_chk, __sprintf_chk, PEMU_LIBC_2_3_4);
compat_symbol (libc, __nldbl___vsprintf_chk, __vsprintf_chk, PEMU_LIBC_2_3_4);
compat_symbol (libc, __nldbl___snprintf_chk, __snprintf_chk, PEMU_LIBC_2_3_4);
compat_symbol (libc, __nldbl___vsnprintf_chk, __vsnprintf_chk, PEMU_LIBC_2_3_4);
compat_symbol (libc, __nldbl___printf_chk, __printf_chk, PEMU_LIBC_2_3_4);
compat_symbol (libc, __nldbl___fprintf_chk, __fprintf_chk, PEMU_LIBC_2_3_4);
compat_symbol (libc, __nldbl___vprintf_chk, __vprintf_chk, PEMU_LIBC_2_3_4);
compat_symbol (libc, __nldbl___vfprintf_chk, __vfprintf_chk, PEMU_LIBC_2_3_4);
#endif
