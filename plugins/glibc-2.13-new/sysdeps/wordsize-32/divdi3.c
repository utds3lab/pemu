...
compat_symbol (libc, __divdi3, __divdi3, PEMU_LIBC_2_0);
compat_symbol (libc, __moddi3, __moddi3, PEMU_LIBC_2_0);
compat_symbol (libc, __udivdi3, __udivdi3, PEMU_LIBC_2_0);
compat_symbol (libc, __umoddi3, __umoddi3, PEMU_LIBC_2_0);
#endif
