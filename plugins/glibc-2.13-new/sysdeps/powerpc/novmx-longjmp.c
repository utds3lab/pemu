...
# if __WORDSIZE == 64
symbol_version (__novmx_longjmp,_longjmp,PEMU_LIBC_2.3);
symbol_version (__novmxlongjmp,longjmp,PEMU_LIBC_2.3);
symbol_version (__novmxsiglongjmp,siglongjmp,PEMU_LIBC_2.3);
# else
symbol_version (__novmx_longjmp,_longjmp,PEMU_LIBC_2.0);
symbol_version (__novmxlongjmp,longjmp,PEMU_LIBC_2.0);
symbol_version (__novmxsiglongjmp,siglongjmp,PEMU_LIBC_2.0);
# endif
