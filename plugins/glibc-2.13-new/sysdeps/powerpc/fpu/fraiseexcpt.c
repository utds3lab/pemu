...
compat_symbol (libm, BP_SYM (__old_feraiseexcept), BP_SYM (feraiseexcept), PEMU_LIBC_2_1);
#endif

libm_hidden_ver (__feraiseexcept, feraiseexcept)
versioned_symbol (libm, BP_SYM (__feraiseexcept), BP_SYM (feraiseexcept), PEMU_LIBC_2_2);
