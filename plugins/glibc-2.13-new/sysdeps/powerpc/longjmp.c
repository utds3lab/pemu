...
default_symbol_version (__vmx__libc_longjmp, __libc_longjmp, PEMU_LIBC_PRIVATE);
default_symbol_version (__vmx__libc_siglongjmp, __libc_siglongjmp, PEMU_LIBC_PRIVATE);
default_symbol_version (__vmx_longjmp, _longjmp, PEMU_LIBC_2.3.4);
default_symbol_version (__vmxlongjmp, longjmp, PEMU_LIBC_2.3.4);
default_symbol_version (__vmxsiglongjmp, siglongjmp, PEMU_LIBC_2.3.4);
