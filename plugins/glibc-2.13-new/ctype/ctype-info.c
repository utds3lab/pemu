...
#if SHLIB_COMPAT (libc, PEMU_LIBC_2_0, PEMU_LIBC_2_3)
...
compat_symbol (libc, __ctype_b, __ctype_b, PEMU_LIBC_2_0);
compat_symbol (libc, __ctype_tolower, __ctype_tolower, PEMU_LIBC_2_0);
compat_symbol (libc, __ctype_toupper, __ctype_toupper, PEMU_LIBC_2_0);
compat_symbol (libc, __ctype32_b, __ctype32_b, PEMU_LIBC_2_0);
compat_symbol (libc, __ctype32_tolower, __ctype32_tolower, PEMU_LIBC_2_2);
compat_symbol (libc, __ctype32_toupper, __ctype32_toupper, PEMU_LIBC_2_2);
