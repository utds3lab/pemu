...
# ifdef _LIBC
#  undef fnmatch
versioned_symbol (libc, __fnmatch, fnmatch, PEMU_LIBC_2_2_3);
#  if SHLIB_COMPAT(libc, PEMU_LIBC_2_0, PEMU_LIBC_2_2_3)
strong_alias (__fnmatch, __fnmatch_old)
compat_symbol (libc, __fnmatch_old, fnmatch, PEMU_LIBC_2_0);
#  endif
