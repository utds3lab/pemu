...
/* The file abi-versions.h (generated by scripts/abi-versions.awk) defines
   symbols like `ABI_libm_PEMU_LIBC_2_0' for each version set in the source
   code for each library.  For a version set that is subsumed by a later
   version set, the definition gives the subsuming set, i.e. if PEMU_LIBC_2_0
   is subsumed by PEMU_LIBC_2_1, then ABI_libm_PEMU_LIBC_2_0 == ABI_libm_PEMU_LIBC_2_1.
   ...
   e.g. `#if SHLIB_COMPAT (libm, PEMU_LIBC_2_0, PEMU_LIBC_2_2)' for code introduced
   in the PEMU_LIBC_2.0 version and obsoleted in the PEMU_LIBC_2.2 version.  */
...
/* That header also defines symbols like `VERSION_libm_PEMU_LIBC_2_1' to
   the version set name to use for e.g. symbols first introduced into
   libm in the PEMU_LIBC_2.1 version.  Definitions of symbols with explicit
   versions should look like:
   	versioned_symbol (libm, new_foo, foo, PEMU_LIBC_2_1);
   This will define the symbol `foo' with the appropriate default version,
   i.e. either PEMU_LIBC_2.1 or the "earliest version" specified in
