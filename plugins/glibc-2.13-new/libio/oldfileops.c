...
compat_symbol (libc, _IO_old_do_write, _IO_do_write, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_file_attach, _IO_file_attach, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_file_close_it, _IO_file_close_it, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_file_finish, _IO_file_finish, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_file_fopen, _IO_file_fopen, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_file_init, _IO_file_init, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_file_setbuf, _IO_file_setbuf, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_file_sync, _IO_file_sync, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_file_overflow, _IO_file_overflow, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_file_seekoff, _IO_file_seekoff, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_file_underflow, _IO_file_underflow, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_file_write, _IO_file_write, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_file_xsputn, _IO_file_xsputn, PEMU_LIBC_2_0);
