...
versioned_symbol (libc, _IO_new_popen, _IO_popen, PEMU_LIBC_2_1);
versioned_symbol (libc, __new_popen, popen, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_proc_open, _IO_proc_open, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_proc_close, _IO_proc_close, PEMU_LIBC_2_1);
