...
compat_symbol (libc, _IO_old_popen, _IO_popen, PEMU_LIBC_2_0);
compat_symbol (libc, __old_popen, popen, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_proc_open, _IO_proc_open, PEMU_LIBC_2_0);
compat_symbol (libc, _IO_old_proc_close, _IO_proc_close, PEMU_LIBC_2_0);
