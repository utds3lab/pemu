     ...
     _IO_FILE *fp;
{
  ...
  /* Free buffer. */
#if defined _LIBC || defined _PEMU_LIBCPP_USE_WCHAR_T
  if (fp->_mode > 0)
    {
...
versioned_symbol (libc, _IO_new_do_write, _IO_do_write, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_file_attach, _IO_file_attach, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_file_close_it, _IO_file_close_it, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_file_finish, _IO_file_finish, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_file_fopen, _IO_file_fopen, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_file_init, _IO_file_init, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_file_setbuf, _IO_file_setbuf, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_file_sync, _IO_file_sync, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_file_overflow, _IO_file_overflow, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_file_seekoff, _IO_file_seekoff, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_file_underflow, _IO_file_underflow, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_file_write, _IO_file_write, PEMU_LIBC_2_1);
versioned_symbol (libc, _IO_new_file_xsputn, _IO_file_xsputn, PEMU_LIBC_2_1);
#endif
