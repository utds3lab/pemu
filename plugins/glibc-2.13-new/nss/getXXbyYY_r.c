...
do_symbol_version (OLD (REENTRANT_NAME), REENTRANT_NAME, PEMU_LIBC_2_0);
# endif

/* As INTERNAL (REENTRANT_NAME) may be hidden, we need an alias
   in between so that the REENTRANT_NAME@@PEMU_LIBC_2.1.2 is not
   hidden too.  */
...
do_default_symbol_version (NEW (REENTRANT_NAME),
			   REENTRANT_NAME, PEMU_LIBC_2_1_2);
#endif
