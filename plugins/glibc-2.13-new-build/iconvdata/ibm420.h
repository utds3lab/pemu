...
static const struct gap from_idx[] = {
  ...
  { .start = 0x0660, .end = 0x0669, .idx = -1406 },
  { .start = 0xfe7d, .end = 0xfe84, .idx = -64913 },
  { .start = 0xfe8e, .end = 0xfea7, .idx = -64922 },
  { .start = 0xfeb3, .end = 0xfebf, .idx = -64933 },
  { .start = 0xfeca, .end = 0xfefc, .idx = -64943 },
...
static const char from_ucs4[] = {
  ...
  '\x47', '\x49', '\x52', '\x00', '\x55', '\x56', '\x58', '\x62',
  ...
  '\xfb', '\xfc', '\xfd', '\xfe', '\x43', '\x00', '\x00', '\x00',
  '\x00', '\x48', '\x00', '\x51', '\x57', '\x00', '\x00', '\x59',
  '\x00', '\x00', '\x00', '\x00', '\x00', '\x64', '\x00', '\x00',
  '\x00', '\x66', '\x00', '\x00', '\x00', '\x68', '\x00', '\x00',
  '\x00', '\x70', '\x00', '\x00', '\x00', '\x72', '\x78', '\x00',
  '\x00', '\x00', '\x8a', '\x00', '\x00', '\x00', '\x8c', '\x00',
  '\x00', '\x00', '\x8e', '\x9b', '\x9c', '\x9d', '\x00', '\x9f',
  '\xa0', '\xaa', '\x00', '\x00', '\xac', '\x00', '\x00', '\x00',
  '\xae', '\x00', '\x00', '\x00', '\xb0', '\x00', '\x00', '\x00',
  '\xba', '\x00', '\x00', '\x00', '\xbc', '\x00', '\x00', '\x00',
  '\xbe', '\x00', '\x00', '\x00', '\xcb', '\xcd', '\x00', '\x00',
  '\x00', '\xdb', '\x00', '\xdd', '\xde', '\x00', '\xb2', '\xb3',
  '\xb4', '\xb5', '\x00', '\x00', '\xb8', '\xb9',
};
