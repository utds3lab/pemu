...
static const struct gap from_idx[] = {
  ...
  { .start = 0x0192, .end = 0x0192, .idx =  -244 },
  { .start = 0x0384, .end = 0x03ce, .idx =  -741 },
  { .start = 0x2013, .end = 0x2026, .idx = -7977 },
  { .start = 0x2030, .end = 0x2030, .idx = -7986 },
  { .start = 0x2039, .end = 0x203a, .idx = -7994 },
  { .start = 0x20ac, .end = 0x20ac, .idx = -8107 },
  { .start = 0x2122, .end = 0x2122, .idx = -8224 },
...
static const char from_ucs4[] = {
  ...
  '\xa0', '\x00', '\x00', '\xa3', '\xa4', '\xa5', '\xa6', '\xa7',
  '\xa8', '\xa9', '\x00', '\xab', '\xac', '\xad', '\xae', '\x00',
  '\xb0', '\xb1', '\xb2', '\xb3', '\x00', '\xb5', '\xb6', '\xb7',
  '\x00', '\x00', '\x00', '\xbb', '\x00', '\xbd', '\x83', '\xb4',
  '\xa1', '\xa2', '\x00', '\xb8', '\xb9', '\xba', '\x00', '\xbc',
  ...
  '\xfd', '\xfe', '\x96', '\x97', '\xaf', '\x00', '\x00', '\x91',
