...
static const struct gap from_idx[] = {
  ...
  { .start = 0x02c7, .end = 0x02c7, .idx =  -420 },
  { .start = 0x02d9, .end = 0x02db, .idx =  -437 },
  { .start = 0x2013, .end = 0x2026, .idx = -7916 },
  { .start = 0x2030, .end = 0x2030, .idx = -7925 },
  { .start = 0x2039, .end = 0x203a, .idx = -7933 },
  { .start = 0x20ac, .end = 0x20ac, .idx = -8046 },
  { .start = 0x2122, .end = 0x2122, .idx = -8163 },
...
static const char from_ucs4[] = {
  ...
  '\x8d', '\xa9', '\x00', '\xab', '\xac', '\xad', '\xae', '\x9d',
  '\xb0', '\xb1', '\xb2', '\xb3', '\xb4', '\xb5', '\xb6', '\xb7',
  '\x8f', '\xb9', '\x00', '\xbb', '\xbc', '\xbd', '\xbe', '\x00',
  ...
  '\xfd', '\xde', '\xfe', '\x8e', '\xff', '\x00', '\x9e', '\x96',
  '\x97', '\x00', '\x00', '\x00', '\x91', '\x92', '\x82', '\x00',
  '\x93', '\x94', '\x84', '\x00', '\x86', '\x87', '\x95', '\x00',
  '\x00', '\x00', '\x85', '\x89', '\x8b', '\x9b', '\x80', '\x99',
};
