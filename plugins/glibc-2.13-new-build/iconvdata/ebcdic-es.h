...
static const struct gap from_idx[] = {
  ...
  { .start = 0x00d1, .end = 0x00d1, .idx =   -36 },
  { .start = 0x00f1, .end = 0x00f1, .idx =   -67 },
  { .start = 0x20a7, .end = 0x20a7, .idx = -8184 },
...
static const char from_ucs4[] = {
  ...
  '\x40', '\x5a', '\x7f', '\x00', '\x00', '\x6c', '\x50', '\x7d',
  ...
  '\x00', '\x00', '\x4a', '\x00', '\x00', '\x00', '\x00', '\x00',
  '\xa1', '\x00', '\x00', '\x00', '\x5f', '\x7b', '\x6a', '\x5b',
};
