...
static const struct gap from_idx[] = {
  ...
  { .start = 0x00b7, .end = 0x00b7, .idx =   -50 },
  { .start = 0x0401, .end = 0x0407, .idx =  -891 },
  { .start = 0x0410, .end = 0x0457, .idx =  -899 },
  { .start = 0x0490, .end = 0x0491, .idx =  -955 },
  { .start = 0x2116, .end = 0x2116, .idx = -8255 },
  { .start = 0x221a, .end = 0x221a, .idx = -8514 },
...
static const char from_ucs4[] = {
  ...
  '\xff', '\x00', '\x00', '\x00', '\xfd', '\xfa', '\xf0', '\x00',
  '\x00', '\xf4', '\x00', '\xf6', '\xf8', '\x80', '\x81', '\x82',
  ...
  '\xeb', '\xec', '\xed', '\xee', '\xef', '\x00', '\xf1', '\x00',
  '\x00', '\xf5', '\x00', '\xf7', '\xf9', '\xf2', '\xf3', '\xfc',
  '\xfb', '\xc4', '\x00', '\xb3', '\xda', '\x00', '\x00', '\x00',
